function Remove() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="36" height="30" fill="none" viewBox="0 0 36 30">
      <g filter="url(#filter0_d_4156_38566)">
        ...
        <path
          ...
          clipRule="evenodd"
        ></path>
        <rect width="31" height="23" x="2.5" y="0.5" stroke="#EB5757" rx="7.5"></rect>
      </g>
      <defs>
        <filter
          id="filter0_d_4156_38566"
          width="36"
          height="30"
          x="0"
          y="0"
        ...
        >
          ...
          <feBlend in2="BackgroundImageFix" result="effect1_dropShadow_4156_38566"></feBlend>
          <feBlend in="SourceGraphic" in2="effect1_dropShadow_4156_38566" result="shape"></feBlend>
        </filter>
      </defs>
    </svg>
  )
